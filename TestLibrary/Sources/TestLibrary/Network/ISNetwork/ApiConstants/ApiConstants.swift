...
internal enum ApiConstants {
    ...
    nonisolated(unsafe) static var baseUrl = (environment == .production) ? Self.productionUrl : Self.developmentUrl
    
    nonisolated(unsafe) public static var productionUrl = "https://userapi.isendremit.com/api/" // "https://userapi.isendglobal.com/api/"
    nonisolated(unsafe) public static var developmentUrl = "https://devusa.isendglobal.com/api/" // "https://devapi.isend.com.sg/api/"
